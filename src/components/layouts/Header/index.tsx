...
const Header: React.FC<HeaderProps> = ({ timelineIdx, onSetTlIdx }) => {
  ...
  const socialIcons: ISocialIcon[] = useMemo(
    () => [
      {
        icon: faGithub,
        link: "https://github.com/NithinR12/",
      },
      // {
      //   icon: faInstagram,
      //   link: "https://github.com/NithinR12/",
      ...
      {
        icon: faLinkedin,
        link: "www.linkedin.com/in/nithin-r-coim",
      },
    ],
    []
  );
  ...
  return (
    <>
      ...
      >
        <Wrapper ref={wrapperEl}>
          ...
          <Nav isVisible={toggleMenu}>
            ...
            <Resume>
              <a href="/Nithin_R.pdf" download="Nithin_R.pdf">
                Resume
              </a>
            </Resume>
          </Nav>
      ...
      <MailContainer ref={mailContainerEl}>
        <Mail href="mailto:nm12022000@gmail.com">nm12022000@gmail.com</Mail>
      </MailContainer>
    </>
  );
};
